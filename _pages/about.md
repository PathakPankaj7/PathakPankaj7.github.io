...
<!-- Images side by side with vertical and horizontal gap adjustments -->
<div style="margin-top: 40px; display: flex; justify-content: center; align-items: center; gap: 10px;">
  <!-- First and second logos stacked vertically -->
  <div style="display: flex; flex-direction: column; gap: 10px;">
    <img src="/images/l1.jpg" alt="Logo 1" style="width: 200px;">
    <img src="/images/l2.jpg" alt="Logo 2" style="width: 200px;">
  </div>
  <!-- Third logo centered horizontally between the first and second logos -->
  <img src="/images/l3.jpg" alt="Logo 3" style="width: 200px; align-self: center;">
</div>
